...
?><div class="panel panel-body"><h4>Academic assignment overview</h4><p class="help-block">Selected academic year; subject counts use <?= isset($arTerm)?($arTerm?'whole-year and selected-term assignments':'assignments from all terms'):'whole-year and active-term assignments' ?>.</p><div class="row"><?php foreach($arStats as $label=>$stat) { ?><div class="col-sm-3"><p><strong><?= (int)academic_query($dbh,$stat[0],$stat[1])->fetchColumn() ?></strong> <?= academic_h($label) ?></p></div><?php } ?></div><p><?php if(staff_can('accounts.teachers')) { ?><a href="manage-teachers.php#create-teacher">Add Teacher</a><?php } ?> · <a href="dean-teacher-relationships.php#assign">Assign Subject Teacher / Class Teacher</a> · <a href="manage-subjects.php">Manage Subjects</a> · <?php if(staff_can('assignments.responsibility')||staff_can('responsibilities.manage')) { ?><a href="dean-teacher-relationships.php#responsibilities">Manage Academic Responsibilities</a><?php } ?> · <a href="student-subjects.php">Student Subject Combinations</a></p></div><?php } ?>
